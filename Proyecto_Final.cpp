...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		////Carga de modelo 
		////tortuga Brazo Derecho
		//view = camera.GetViewMatrix();
		//model = glm::mat4(1);
		////model = glm::translate(model, PosIni + glm::vec3(movKitX, 0, movKitZ));
		//model = glm::translate(model, glm::vec3(-55.0f, 0.375f, 11.8f));;
		//model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 1.0f, 0.0));
		//model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));

		//BrazoDerecho_Tortuga.Draw(lightingShader);


		////Carga de modelo 
		////tortuga Brazo Izquierdo
		//view = camera.GetViewMatrix();
		//model = glm::mat4(1);
		////model = glm::translate(model, PosIni + glm::vec3(movKitX, 0, movKitZ));
		//model = glm::translate(model, glm::vec3(-56.5f, 0.32f, 11.5f));;///-54++ se pasa al norte,//bien,//
		//model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 1.0f, 0.0));
		//model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));

		//BrazoIzquierdo_Tortuga.Draw(lightingShader);


		////Carga de modelo 
		////tortuga pata derecha
		//view = camera.GetViewMatrix();
		//model = glm::mat4(1);
		////model = glm::translate(model, PosIni + glm::vec3(movKitX, 0, movKitZ));
		//model = glm::translate(model, glm::vec3(-55.0f, 0.38f, 11.0f));;///-50.1 antes//bien,//
		//model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 1.0f, 0.0));
		//model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));

		//PataDerecha_Tortuga.Draw(lightingShader);
	...
	//Rueda de Molino
		...
		////////////////posibles erroresssssssssssssssssssssssssssssssssss
		////Carga de modelo 
		////Muelle
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		...
		//view = camera.GetViewMatrix();
		//model = glm::mat4(1);
		//model = glm::translate(model, PosIni + glm::vec3(58.2f, 0.0f, 35.7f));
		//model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 1.0f, 0.0));
		//model = glm::scale(model, glm::vec3(0.05f, 0.05f, 0.05f));
		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//view = camera.GetViewMatrix();
		//model = glm::mat4(1);
		//model = glm::translate(model, PosIni + glm::vec3(58.2f, 0.0f, 15.7f));
		//model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 1.0f, 0.0));
		//model = glm::scale(model, glm::vec3(0.05f, 0.05f, 0.05f));
		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		////Carga de modelo ////tronco que estorba a la lancha
		////Tronco 
		//view = camera.GetViewMatrix();
		//model = glm::mat4(1);
		////model = glm::translate(model, PosIni + glm::vec3(movKitX, 0, movKitZ));
		//model = glm::translate(model, glm::vec3(-55.0f, 0.0f, -37.7f));
		//model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 1.0f, 0.0));
		//model = glm::scale(model, glm::vec3(0.9f, 0.9f, 0.9f));
		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//////////////Posibles nuevas cabañas
		////Carga de modelo 
		////arbol 1
		//view = camera.GetViewMatrix();
		//model = glm::mat4(1);
		//model = glm::translate(model, PosIni + glm::vec3(65.2f, 0.0f, 7.7f));
		//model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 1.0f, 0.0));
		//model = glm::scale(model, glm::vec3(0.05f, 0.05f, 0.05f));
		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//view = camera.GetViewMatrix();
		//model = glm::mat4(1);
		//model = glm::translate(model, PosIni + glm::vec3(75.2f, 0.0f, 7.7f));
		//model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 1.0f, 0.0));
		//model = glm::scale(model, glm::vec3(0.05f, 0.05f, 0.05f));
		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
...
////////////////////////////////////////////////cambio de sentido en el recorrido
...
////////////////////////////////////////////////Fin cambio de sentido en el recorrido


/////////////////////////////////////////////////////////////////////////////////recorrido con pendiente
